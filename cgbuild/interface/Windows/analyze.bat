...
REM 
REM * The Python.exe is located at C:\Program Files\CGpython
...
REM set scanner=C:\Program Files\CGpython\python.exe %CG_TOOLS_HOME%\c\interface_scripts\analyze\sonar_scanner.py
