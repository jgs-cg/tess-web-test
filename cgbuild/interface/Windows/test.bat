...
REM C:\Program Files\CGpython\python.exe -m venv python
...
REM Run Powershell Module Unit Tests
REM echo Running Powershell Tests
REM PowerShell.exe -Command ". E:\synced_repos\interface_scripts\buildutil\powershell\PSModuleCI.ps1; RunPesterTests %XUNIT_RESULTS_PATH% %BASE_DIR%"
