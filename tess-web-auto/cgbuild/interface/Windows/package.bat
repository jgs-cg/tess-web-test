...
REM Package and Publish Powershell Modules
REM echo Calling powershell cmd
REM PowerShell.exe -Command ". E:\synced_repos\interface_scripts\buildutil\powershell\PSModuleCI.ps1; PublishModules %CG_APP_VERSION% %CG_BUILD_NUMBER% %CG_NUGETAPIKEY%"
