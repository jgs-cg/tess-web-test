...
# -------------------------------------------------------------------------
# 
# * The Python is located in a sub folder in /users/python/CGpython/bin
...
# exclusions=
# scanner="/users/python/CGpython/bin/python ${CG_TOOLS_HOME}/c/interface_scripts/analyze/sonar_scanner.py"
